            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="position-relative" style="background-color: #1e3a8a; min-height: 80vh;">
                        ...
                        <!-- Content -->
                        <div class="container position-relative text-white py-5 d-flex align-items-center justify-content-center"
                                    ...
                                    <div
                                        ...
                                        <div class="text-center text-md-start">
                                            ...
                                            <a href="{{ route('promotion') }}"
                                                class="btn btn-warning text-dark fw-bold rounded-pill mt-3">
